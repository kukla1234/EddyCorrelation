									...
									<div id="slideshow" class="carousel slide" data-interval="false">
										<div class="carousel-inner">
											<div class="item active">
												<img src="/berg/img/data/PlotWebSite2.jpg" alt="data example 2">
												<div class="carousel-caption datacaption">
													<p class="carouselcaption datacaption">
														...
														<a href="/berg/gallery.php#floridakeys">Gallery</a>
														<br/><br/>
														...
														The clear water over this subtropical reef allowed data of this rare high quality to be measured. For further details on the data, see <a target="_blank" href="/berg/publications/Long%20et%20al%202013%20PLOS%20ONE.pdf"> Long et al. (2013) </a>.
													</p>
												</div>
											</div>
									</div><!-- /.carousel -->
