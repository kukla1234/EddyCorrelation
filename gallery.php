...
/*
function printGalleryNode($divid, $h3text, $rowinfo){
	print ' <h3 class="gallery-header">'.$h3text.'</h3>
			<div class="imageRow"> ';
//	foreach($rowinfo as $val){
			printImageSet($rowinfo[0],$rowinfo[1]);
	//	}
		print 	'</div>
				';
} */
/*
function printImageSet($groupname, $directory ){ //, $imageNames 
	$imageNames = str_replace(" ", "%20", getDirectoryList('img/'.$directory.'/pics/') );
	print '<div class="set">';
	for($i = 0; $i < count($imageNames); $i++) {
		print '<a class="single" href="img/'.$directory.'/pics/'.$imageNames[$i].'" rel="lightbox['.$groupname.']"><img src="img/'.$directory.'/thumbs/tn_'.$imageNames[$i].'" alt="'.$imageNames[$i].'" /></a>';
	} 
	print '</div>';
}
 */
...
?>
					...
					<?php /*
					<div class="row-fluid">
						<div class="span1 sidebar tabbable tabs-left">
							<ul class="nav nav-tabs">
								<li class="nav-tab-blue"> <a href="#earlyDays">Early Days</a> </li>
								<li class="nav-tab-blue"> <a href="#easternShore">Eastern Shore</a> </li>
								<li class="nav-tab-blue"> <a href="#floridaKeys">Florida Keys</a> </li>
								<li class="nav-tab-blue"> <a href="#gulfOfMexico">Florida Gulf of Mexico</a> </li>
								<li class="nav-tab-blue"> <a href="#wakullaRiver">Florida Wakulla River</a> </li>
								<li class="nav-tab-blue"> <a href="#greenland">Greenland - Under Sea Ice</a> </li>
								<li class="nav-tab-blue"> <a href="#japan">Japan - Deep Ocean</a></li>
								<li class="nav-tab-blue"> <a href="#savannah">Savannah - Permeable Shelf Sediments</a></li>
								<li class="nav-tab-blue"> <a href="#switzerland">Switzerland - Freshwater</a></li>
								<li class="nav-tab-blue"> <a href="#calciumTest">Test of Calcium Sensor</a></li>
								<li class="nav-tab-blue"> <a href="#wisconsin"> Wisconsin - Quagga mussels overgrown</a></li>
								<li class="nav-tab-blue"> <a href="#woodsHole">Woods Hole - Permeable Sediments</a></li>
							</ul>
						</div> */?>							
