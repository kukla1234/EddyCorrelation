									...
									<div id="slideshow" class="carousel slide" data-interval="false">
										<div class="carousel-inner">
											<div class="item active">
												<img src="/berg/img/data/PlotWebSite1.jpg" alt="data example 1">
												...
												<div class="carousel-caption datacaption">
                                                    ...
                                                    <a href="/berg/gallery.php#floridagulf">Gallery</a>
                                        			<br/><br/>
													...
													For further details on the data, see <a target="__blank" href="/berg/publications/Berg%20and%20Huettel%202008%20Oceanography.pdf">Berg and Huettel (2008)</a> . The 16 Hz data (time, v<sub>x</sub>, v<sub>y</sub>, v<sub>z</sub>, O2) for this example can be downloaded here: <a href="data/BergData1.zip">BergData1</a>
													</p>
												</div>
											</div>
									</div><!-- /.carousel -->
