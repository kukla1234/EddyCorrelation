			...
			<div class="wrapper-content container-fluid">
				...
				<div class="row-fluid">
					<div class="span12 publications">
                        ...
                        printCitation("<b>Long, M.H.</b>, <b>P. Berg</b> J. L. Falter. (Submitted). Seagrass Metabolism across a Productivity Gradient using the Eddy Correlation, Eulerian Control Volume, and Biomass Addition Techniques. <b>J. Geophys. Res.: Oceans.</b>.");
                        printCitation("<b>Koopmans,D.</b>, <b>P. Berg</b> (Submitted). Stream oxygen flux and metabolism determined with the open water and eddy correlation techniques. <b>Limnology and Oceanography</b>.");
