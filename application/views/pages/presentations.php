...
<body>
    <div class='berg_content'>
        ...
        <p>
            The PowerPoint slides and animations available here have all been used in our presentations on the 
            eddy covariance technique. The slides and animations must be viewed in ‘Slide Show’ mode to work 
            correctly. A brief explanation is given in the PowerPoint text box below each of them. Please reference 
            to the slides and animations as indicated on them:
        </p>

        <div class='berg_weblink berg_align-center'>
            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Instrument%20animation.ppt" target="_blank">Instrument animation</a>
            ...
            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Instrument%20illustration.ppt>">Instrument illustration</a>
                – Illustration of an instrument on the seafloor and its footprint.
            </p>
            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Visible%20eddy%20correlation%20in%20data%201.ppt">Visible eddy covariance in data 1</a>
                – Real data with visible covariance between the vertical velocity and oxygen concentration that gives the flux. 
            </p>

            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Visible%20eddy%20correlation%20in%20data%202.pp">Visible eddy covariance in data 2</a>
                 – Same as above but with cumulative flux calculation added.
            </p>

            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Eddy%20correlation%20footprint.ppt">Eddy covariance footprint</a>
            ...
            <p class='berg_citation-text text berg_indent-block'>
                <a href="/berg/img/slides/Transport%20by%20turbulent%20eddy.ppt">Transport by turbulent eddy</a>
