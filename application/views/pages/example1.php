										...
										<div class="carousel-inner">
											<div class="item active">
												...
												<div class="carousel-caption datacaption">
                                                    ...
                                                    <a href="/gallery.php#floridagulf">Gallery</a>
                                        			<br/><br/>
													...
													For further details on the data, see <a target="__blank" href="/publications/Berg%20and%20Huettel%202008%20Oceanography.pdf">Berg and Huettel (2008)</a> . The 16 Hz data (time, v<sub>x</sub>, v<sub>y</sub>, v<sub>z</sub>, O2) for this example can be downloaded here: <a href="data/BergData1.zip">BergData1</a>
													</p>
												</div>
											</div>
									</div><!-- /.carousel -->
